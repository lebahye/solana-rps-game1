...
const TokenModal: React.FC<TokenModalProps> = ({ publicKey, balance, onClose, onGetFree }) => {
  return (
      ...
      <div className="bg-gray-800 p-6 rounded-lg max-w-md w-full mx-4">
        ...
        <div className="space-y-4">
          <div>
            ...
            <div className="text-sm font-mono">{publicKey?.toString()}</div>
          </div>
          
          <div>
            <div className="text-sm text-gray-400">SOL Balance</div>
            <div className="text-lg">{balance.sol.toFixed(4)} SOL</div>
          </div>
          
          <div>
            <div className="text-sm text-gray-400">RPS Token Balance</div>
            <div className="text-lg">{balance.rpsToken.toFixed(2)} RPS</div>
          </div>
